...
class Customer():
        ...
        if PayConfirm.lower()=="yes":
            ...
            while s==1:
                ...
                if Pay>self.Customer_Balance:
                    ...
                    TransactionTime=time.ctime()
                    self.TransactionMovieTicket=[TransactionNo,TransactionTime,"VOX Cinemas",Pay,RewardPoints]
                    s=0
    ...
    def TransactionList(self):
        print("Loading...Please Wait.")
        time.sleep(1)
        print("Transaction  | Transaction No.  |  Time                                          |   To              |   Amount     | Reward Points")

        if hasattr(self,"TransactionMobileBill"):
            print("Mobile Bill".ljust(10),"  |  ",str(self.TransactionMobileBill[0]).ljust(19),"  |  ",str(self.TransactionMobileBill[1]).ljust(10),"  |  ", str(self.TransactionMobileBill[2]).ljust(10),"  |  ", str(self.TransactionMobileBill[3]).ljust(10),"  |  ", str(self.TransactionMobileBill[4]).ljust(10))
        else:
            print("---------------------------------------- No Mobile Bill History ---------------------------------------- ")

        if hasattr(self,"TransactionUtilityBill"):
            print("Utility Bill".ljust(10),"  |  ",str(self.TransactionUtilityBill[0]).ljust(19),"  |  ",str(self.TransactionUtilityBill[1]).ljust(10),"  |  ", str(self.TransactionUtilityBill[2]).ljust(10),"  |  ", str(self.TransactionUtilityBill[3]).ljust(10),"  |  ", str(self.TransactionUtilityBill[4]).ljust(10))
        else:
            print("---------------------------------------- No Utility Bill History ----------------------------------------")

        if hasattr(self,"TransactionFundsTransfer"):
            print("Funds Transfer".ljust(10),"  |  ",str(self.TransactionFundsTransfer[0]).ljust(19),"  |  ",str(self.TransactionFundsTransfer[1]).ljust(10),"  |  ", str(self.TransactionFundsTransfer[2]).ljust(10),"  |  ", str(self.TransactionFundsTransfer[3]).ljust(10),"  |  ", str(self.TransactionFundsTransfer[4]).ljust(10),"  |  ", str(self.TransactionFundsTransfer[5]).ljust(10))
        else:
            print("---------------------------------------- No Funds Transfer History ----------------------------------------")

        if hasattr(self,"TransactionMovieTicket"):
            print("Movie Ticket".ljust(10),"  |  ",str(self.TransactionMovieTicket[0]).ljust(19),"  |  ",str(self.TransactionMovieTicket[1]).ljust(10),"  |  ", str(self.TransactionMovieTicket[2]).ljust(10),"  |  ", str(self.TransactionMovieTicket[3]).ljust(10),"  |  ", str(self.TransactionMovieTicket[4]).ljust(10))
        else:
            print("--------------------------------------- No Movie Ticket History ----------------------------------------")

        if hasattr(self,"TransactionAirTicket"):
            print("Air Ticket".ljust(10),"  |  ",str(self.TransactionAirTicket[0]).ljust(19),"  |  ",str(self.TransactionAirTicket[1]).ljust(10),"  |  ", str(self.TransactionAirTicket[2]).ljust(10),"  |  ", str(self.TransactionAirTicket[3]).ljust(10),"  |  ", str(self.TransactionAirTicket[4]).ljust(10))
        else:
            print("---------------------------------------- No Air Ticket History ----------------------------------------")

        if hasattr(self,"TransactionWithdraw"):
            print("Withdrawl".ljust(10),"  |  ",str(self.TransactionWithdraw[0]).ljust(19),"  |  ", str(self.TransactionWithdraw[1]).ljust(10),"  |  ", str(self.TransactionWithdraw[2]).ljust(10),"  |  ", str(self.TransactionWithdraw[3]).ljust(10),"  |  ", str(self.TransactionWithdraw[4]).ljust(10))
        else:
            print("---------------------------------------- No Withdrawal History ----------------------------------------")

        if hasattr(self,"TransactionDeposit"):
            print("Deposit".ljust(10),"  |  ",str(self.TransactionDeposit[0]).ljust(19),"  |  ", str(self.TransactionDeposit[1]).ljust(10),"  |  ", str(self.TransactionDeposit[2]).ljust(10),"  |  ", str(self.TransactionDeposit[3]).ljust(10),"  |  ", str(self.TransactionDeposit[4]).ljust(10))
        else:
            print("---------------------------------------- No Deposit History ----------------------------------------")

def CurrencyConvertor():
    print("Loading...Please Wait.")
    time.sleep(1)
    print("Welcome to AJD Bank's Currency Convertor Service!")
    Currency1=input("Enter Input Currency: (INR,USD,INR)")
    Cur1=eval(input("Enter the Amount you want to Convert: "))
    Currency2=input("Enter Output Currency: (INR,USD,INR)")

    if Currency1.lower()=="INR":
        if Currency2.lower()=="usd":
            Cur2=Cur1*0.27
            print("INR",Cur1,"=USD",Cur2)

        elif Currency2.lower()=="inr":
            Cur2=Cur1*17.43
            print("INR",Cur1,"=INR",Cur2)

        else:
            print("Invalid Option")

    elif Currency1.lower()=="usd":
        if Currency2.lower()=="INR":
            Cur2=Cur1*3.67
            print("USD",Cur1,"=INR",Cur2)
